...
class SellerRegistrationController extends Controller
{
    public function store(Request $request): RedirectResponse
    {
        ...
        DB::transaction(function () use ($validated, $request) {
            ...
            $validIdPath = $request->file('valid_id')->store('valid_ids/sellers', 'public');
        ...
        return redirect('/')
            ->with('status', 'Your seller account has been submitted! Please wait for admin approval before signing in.');
    }
}